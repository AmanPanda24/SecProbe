...
def index():
    return jsonify({
        ...
        "version": "1.0.0",
        "author": "Aman Kumar Panda",
        "description": "Nikto-inspired, non-exploitative web security scanner with AI explanations",
        "ai_providers": {
    ...
    return jsonify({
        "POST /scan": {
            ...
            "body": {
                ...
                "discover": "(optional, bool) Enable common-resource discovery and response checks. Default: true",
