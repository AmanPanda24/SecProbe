...
banner() {
    ...
    echo "  ║   Nikto-inspired Web Security Scanner            ║"
...
print_success() {
    ...
    echo -e "  secprobe example.com --no-discover      # skip Nikto-like path checks"
    echo -e "  secprobe example.com --debug             # print fetch fingerprint (target/host/HTTPS used)"
    echo
